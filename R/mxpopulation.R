...
#'
#' A dataset of population estimates by municipality level in Mexico. Public data from CONAPO.
...
#'   \item{geoid}{geographic id, defined as state id plus municipio id}
#'   \item{gender}{gender. Cero for males, one for females}
#'   \item{age}{age group}
